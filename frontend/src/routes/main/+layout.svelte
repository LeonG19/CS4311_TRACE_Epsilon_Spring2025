<script>
	...
	onMount(() => {
		...
		const storedInitials = sessionStorage.getItem('analyst_initials');
		if (storedInitials === '' || storedInitials === null) {
			goto('/');
		} else {
	...
	// Pop up to confirm if user wishes to log out.
...
<div class="SB-container">
	<nav class="sidebar">
		<!-- Display User Initials at the Top -->
		<div class="user-initials">
			{#if initials}
				<span title="Current User">{initials}</span>
			{:else}
				<span title="No User">N/A</span>
			{/if}
		</div>
